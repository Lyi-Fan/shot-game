...
export function Game() {
  ...
  return (
    ...
    >
      ...
      <fogExp2 attach="fog" args={['#171717', isMobile ? 0.015 : 0.008]} />
      
      <ambientLight color="#cbd5e1" intensity={isMobile ? 0.8 : 0.5} />
      <pointLight position={[0, 8, 0]} color="#fcd34d" intensity={1.5} castShadow={!isMobile} distance={60} />
      
      {!isMobile && (
        <>
          <pointLight position={[25, 8, 25]} color="#f1f5f9" intensity={1.0} castShadow distance={80} />
          <pointLight position={[-25, 8, -25]} color="#f1f5f9" intensity={1.0} castShadow distance={80} />
          <pointLight position={[25, 8, -25]} color="#fef3c7" intensity={1.0} castShadow distance={80} />
          <pointLight position={[-25, 8, 25]} color="#fef3c7" intensity={1.0} castShadow distance={80} />
        </>
      )}
